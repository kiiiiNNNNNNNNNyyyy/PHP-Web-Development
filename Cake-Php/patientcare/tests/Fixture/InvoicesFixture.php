...
class InvoicesFixture extends TestFixture
{
    ...
    public $fields = [
        'invoices' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'autoIncrement' => true, 'precision' => null],
        ...
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['invoices'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'due' => '2017-04-14 06:38:27',
            'created' => '2017-04-14 06:38:27',
            'modified' => '2017-04-14 06:38:27'
        ],
    ];
}
